...
import 'AfterLayout.dart';

/// @Author : Alex Hu
/// @Contact: hucaihua.lzu@gmail.com
/// @Comment: CustoomHeroWidget
/// @Date: on 2023-06-12 18:34
...
class _CustomHeroAnimationState extends State<CustomHeroAnimation> with SingleTickerProviderStateMixin {
  ...
  Widget wChild1() {
    ...
    return GestureDetector(
      ...
      child: SizedBox(
        width: 50,
        child: ClipOval(child: Image.asset(Assets.imagesLogo)),
      ),
    );
  }
  ...
  Widget wChild2() {
    ...
    return GestureDetector(
      ...
      child: Image.asset(Assets.imagesLogo, width: 400),
    );
  }
